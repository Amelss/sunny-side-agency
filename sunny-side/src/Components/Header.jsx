  ...
  return (
      <div>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 grid-row-auto'>
            <img src="./images/mobile/image-header.jpg" alt="orange" className='absolute top-0 -z-10 h-[600px] md:hidden' />
              <img src="./images/desktop/image-header.jpg" alt="orange" className='hidden md:block absolute top-0 -z-10 col-span-2 ' />
